					...
					<tbody>
						...
						<?php else: ?>
								...
								<tr>
										...
										<td class="cart_total">
												<p id="total-item-<?php echo $item['id']?>" class="cart_total_price">Taka <?php echo $item['cost'] * $item['quantity'];?></p>
										</td>
                  ...
                  <td colspan="2">
                    <table class="table table-condensed total-result">
                        <tr>
                          ...
                          <td>Taka <?php echo $payment_total; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Delivery Cost</td>
                          <td><span id="payment-total">Taka <?php if(isset($_GET['destination'])){ echo $user->destinationAmount($_GET['destination']);}else {
                            echo "0";
                          } ?></span></td>
                        </tr>
                        ...
                        <tr>
                          <td>Total</td>
                          <td><span id="payment-total">Taka <?php if(isset($_GET['destination'])){echo $payment_total+$user->destinationAmount($_GET['destination']);}else {
                            echo $payment_total;
                          } ?></span></td>
                        </tr>
                        <tr>
